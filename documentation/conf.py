...
import os
import sys
# sys.path.append(os.path.abspath('/home/jpp/texts/papers/ISM/TELESCOPE/SRC/telescope_scheduler'))
sys.path.insert(0,os.path.abspath('..'))


# -- Some general info  about the project -----------------------------------------------------------------------------

project = u'Telescope Scheduler'
copyright = u'2019, jpp'
author = u'João Pedro Pedroso'
...
extensions = ['sphinx.ext.todo', 'sphinx.ext.viewcode', 'sphinx.ext.autodoc', 'sphinx.ext.imgmath', 'sphinx.ext.autosummary', 'sphinx.ext.coverage']
